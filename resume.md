...
- Led 3-person internal development team and implemented testing strategy achieving 90% code coverage.
- Identified and fixed critical bugs before launch, including a major router bug affecting user experience that was resolved the night before a major deployment.
- Built tooling to mock API endpoints for simplified testing.

#### Wyndham Hotels
- Built infrastructure for booking accommodations across Wyndham's entire hotel portfolio.
- Assisted in building new checkout system.
- Unified existing applications into cohesive platform.
...
- Led 3-person development team that assisted in building a new platform serving 10,000+ users.
- Mentored newer developers on team best practices.
- Organized code reviews to maintain high code quality standards.
- Implemented comprehensive testing strategy.

#### Mizuho Financial Group
- Built automation tooling that reduced content migration time from days to hours, processing hundreds of pages.
